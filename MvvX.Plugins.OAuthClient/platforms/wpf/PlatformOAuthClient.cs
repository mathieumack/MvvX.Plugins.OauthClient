...
namespace MvvX.Plugins.OAuthClient
{
    public class PlatformOAuthClient : IOAuthClient
    {
        ...
        public void Start(string screenTitle)
        {
            ...
            if (!string.IsNullOrWhiteSpace(ConfigurationManager.AppSettings["MvvX.Plugins.OAuthClient.Wpf.Window.MaxWidth"]))
            {
                int settingsWidth;
                if (int.TryParse(ConfigurationManager.AppSettings["MvvX.Plugins.OAuthClient.Wpf.Window.MaxWidth"], out settingsWidth))
                    maxWidth = settingsWidth;
            }

            if (!string.IsNullOrWhiteSpace(ConfigurationManager.AppSettings["MvvX.Plugins.OAuthClient.Wpf.Window.MaxHeight"]))
            {
                int settingsHeight;
                if (int.TryParse(ConfigurationManager.AppSettings["MvvX.Plugins.OAuthClient.Wpf.Window.MaxHeight"], out settingsHeight))
